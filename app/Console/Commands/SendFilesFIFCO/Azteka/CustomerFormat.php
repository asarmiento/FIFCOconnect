...
class CustomerFormat extends Command
{
     ...
     * @var string
     */
    protected $signature = 'Azteka:CustomerFormat';
    ...
    public function handle()
    {
	    ...
	    //	Excel::download();
	    $fh=fopen(storage_path("app".DIRECTORY_SEPARATOR."FIFCO".DIRECTORY_SEPARATOR."Azteka".DIRECTORY_SEPARATOR."customersFormat.txt"),'w') or die("Se produjo un error al crear el archivo");

	    $sysconf=Sysconf::find(134);
	    ...
	    $local = Storage::disk('local')->path("FIFCO".DIRECTORY_SEPARATOR."Azteka".DIRECTORY_SEPARATOR."customersFormat.txt");
