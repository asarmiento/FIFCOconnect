...
namespace App\Console\Commands\SendFilesFIFCO\Azteka;
...
class CameraFormat extends Command
{
     ...
     * @var string
     */
    protected $signature = 'Azteka:cameraFormat';
    ...
    public function handle()
    {
	    ...
	    $localSysconf=localSysconf::find(8);
	    ...
	    connectionDataBase();
		    ...
		    $sysconf = DB::connection('mysql_fifco')->table('sysconfs')->find(134);
		    $this->info("cliente :".json_encode($sysconf));
		    $fh=fopen(storage_path("app".DIRECTORY_SEPARATOR."FIFCO".DIRECTORY_SEPARATOR."Azteka".DIRECTORY_SEPARATOR."camerasFormat.txt"),'w') or die("Se produjo un error al crear el archivo");
		    ...
		    foreach ($customers AS $customer) {
                ...
                $texto="CR|$sysconf->code|$id|$code|$placa\r\n";
                fwrite($fh,$texto) or die("No se pudo escribir en el archivo");

		    }

		    fclose($fh);
		    $local=Storage::disk('local')->path("FIFCO".DIRECTORY_SEPARATOR."Azteka".DIRECTORY_SEPARATOR."camerasFormat.txt");
