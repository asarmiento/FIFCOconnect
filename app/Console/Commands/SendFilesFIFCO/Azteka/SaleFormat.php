...
class SaleFormat extends Command
{
	 ...
	 * @var string
	 */
	protected $signature='Azteka:saleFormat';
	...
	public function handle()
	{
		...
		connectDBCustomer($localSysconf);
			...
			$fh=fopen(storage_path("app".DIRECTORY_SEPARATOR."FIFCO".DIRECTORY_SEPARATOR."Azteka".DIRECTORY_SEPARATOR."salesFormat.txt"),'w') or die("Se produjo un error al crear el archivo");
		...
		foreach ($dates AS $date) {
			...
			$local=Storage::disk('local')->path("FIFCO".DIRECTORY_SEPARATOR."Azteka".DIRECTORY_SEPARATOR."salesFormat.txt");
