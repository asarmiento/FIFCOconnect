...
class CustomerFormat extends Command
{
     ...
     * @var string
     */
    protected $signature = 'Elimurgue:CustomerFormat';
    ...
    public function handle()
    {
	    ...
	    //	Excel::download();
	    $fh=fopen(storage_path("app".DIRECTORY_SEPARATOR."FIFCO".DIRECTORY_SEPARATOR."Elimurgue".DIRECTORY_SEPARATOR."customersFormat.txt"),'w') or die("Se produjo un error al crear el archivo");
	    ...
	    $local = Storage::disk('local')->path("FIFCO".DIRECTORY_SEPARATOR."Elimurgue".DIRECTORY_SEPARATOR."customersFormat.txt");
