...
class CameraFormat extends Command
{
     ...
     * @var string
     */
    protected $signature = 'Virginia:cameraFormat';
    ...
    public function handle()
    {
	    ...
	    connectionDataBase();
		    ...
		    $fh=fopen(storage_path("app".DIRECTORY_SEPARATOR."FIFCO".DIRECTORY_SEPARATOR."Virginia".DIRECTORY_SEPARATOR."camerasFormat.txt"),'w') or die("Se produjo un error al crear el archivo");
		    ...
		    fclose($fh);
		    $local=Storage::disk('local')->path("FIFCO".DIRECTORY_SEPARATOR."Virginia".DIRECTORY_SEPARATOR."camerasFormat.txt");
