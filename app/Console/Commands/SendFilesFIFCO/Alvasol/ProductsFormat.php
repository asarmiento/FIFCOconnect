...
class ProductsFormat extends Command
{
	 ...
	 * @var string
	 */
	protected $signature='Alvasol:productFormat';
	...
	public function handle()
	{
		...
		$fh=fopen(storage_path("app".DIRECTORY_SEPARATOR."FIFCO".DIRECTORY_SEPARATOR."Alvasol".DIRECTORY_SEPARATOR."productsFormat.txt"),'w') or die("Se produjo un error al crear el archivo");
		...
		$local=Storage::disk('local')->path("FIFCO".DIRECTORY_SEPARATOR."Alvasol".DIRECTORY_SEPARATOR."productsFormat.txt");
