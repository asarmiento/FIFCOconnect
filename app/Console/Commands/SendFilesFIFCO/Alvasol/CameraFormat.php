...
namespace App\Console\Commands\SendFilesFIFCO\Alvasol;
...
class CameraFormat extends Command
{
     ...
     * @var string
     */
    protected $signature = 'Alvasol:cameraFormat';
    ...
    public function handle()
    {
	    ...
	    $localSysconf=localSysconf::find(4);
	    ...
	    connectionDataBase();
		    ...
		    $fh=fopen(storage_path("app".DIRECTORY_SEPARATOR."FIFCO".DIRECTORY_SEPARATOR."Alvasol".DIRECTORY_SEPARATOR."camerasFormat.txt"),'w') or die("Se produjo un error al crear el archivo");
		    ...
		    foreach ($customers AS $customer) {
			    ...
			    $texto="CR|$sysconf->code|$customer->id|$code|$placa\r\n";
			    fwrite($fh,$texto) or die("No se pudo escribir en el archivo");

		    }

		    fclose($fh);
		    $local=Storage::disk('local')->path("FIFCO".DIRECTORY_SEPARATOR."Alvasol".DIRECTORY_SEPARATOR."camerasFormat.txt");
