...
class CustomerFormat extends Command
{
     ...
     * @var string
     */
    protected $signature = 'Jucasoto:CustomerFormat';
    ...
    public function handle()
    {
	    ...
	    //	Excel::download();
	    $fh=fopen(storage_path("app".DIRECTORY_SEPARATOR."FIFCO".DIRECTORY_SEPARATOR."Jucasoto".DIRECTORY_SEPARATOR."customersFormat.txt"),'w') or die("Se produjo un error al crear el archivo");
	    ...
	    $local = Storage::disk('local')->path("FIFCO".DIRECTORY_SEPARATOR."Jucasoto".DIRECTORY_SEPARATOR."customersFormat.txt");
